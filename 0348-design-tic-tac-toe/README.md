<h2><a href="https://leetcode.com/problems/design-tic-tac-toe/description/?envType=company&envId=apple&favoriteSlug=apple-all">348. Design Tic-Tac-Toe</a></h2><h3>Medium</h3><hr><p>Assume the following rules are for the tic-tac-toe game on an <code>n x n</code> board between two players:</p>
